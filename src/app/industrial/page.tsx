      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "40px", marginTop: "30px" }}>
        ...
        <div className="glass-card" style={{ padding: "0", overflow: "hidden" }}>
          <div style={{ position: "relative", paddingTop: "56.25%" }}>
            <iframe src="https://www.youtube.com/embed/u-MD6akp12c" title="Copper Production" allowFullScreen style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", border: "none" }}></iframe>
          </div>
          <div style={{ padding: "24px", background: "#0b0f19" }}>
            <h4 style={{ color: "#ffffff", fontSize: "1.1rem", fontWeight: 600 }}>Copper Production Process</h4>
            <p style={{ color: "#6b7280", fontSize: "0.85rem", marginTop: "4px" }}>Partner refinery copper production and drawing process</p>
          </div>
        </div>
